                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-lg-6 d-flex align-items-center gradient-custom-2">
                                <div class="text-white px-3 py-4 p-md-5 mx-md-4">
                                    <h4 class="mb-4">¡Más que un Cibercafé: Tu Espacio de Innovación!</h4>
                                    <p class="small mb-0">En Online Coffee, ofrecemos una experiencia única en un ambiente cómodo. Con computadoras de última generación y conexión a Internet rápida, podrás trabajar, navegar o jugar sin interrupciones. También contamos con servicios de impresión, una selección de snacks, bebidas y muchas cosas más... ¡Visítanos y descubre tu lugar ideal para conectarte y disfrutar!</p>
                                </div>
                            </div>
                        </div>
                    </div>
